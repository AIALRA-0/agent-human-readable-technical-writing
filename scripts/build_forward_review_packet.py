"""Render the 20 first-attempt forward candidates for user review."""
...
def main() -> int:
    ...
    print(json.dumps({"status": "PASS", "cases": len(candidates), "output": OUTPUT.as_posix()}, ensure_ascii=False))
    return 0
