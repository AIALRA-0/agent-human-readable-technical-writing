...
独立阅读单元中确属专业名词的内容需要登记官方中文、官方英文、缩写、中文定义、名称含义、名称依据、当前作用和实际影响；`core_terms`、主题关键词和普通操作短语不自动触发该合同；没有正式身份的普通任务标签用自然中文解释，不创造英文形式；确属专业名词但官方写法无法核对时，编译结果进入 `BLOCKED`
