...
术语检查在独立阅读单元中验证确属专业名词的正式中文、官方英文、缩写、定义、名称含义、当前作用和实际影响；行内代码中的专业缩写仍需在相邻文字中完成解释；代码块、网址、路径和逐字引用保持原样；`core_terms`、主题关键词和普通操作短语不能单独证明专业身份；普通任务标签使用自然中文解释且不得创造英文，确属专业名词但无法从登记表或官方来源确认形式时才返回 `REVIEW_REQUIRED`
