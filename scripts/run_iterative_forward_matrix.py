...
Recheck that TABLE rows remain component structure rather than prose `parallel_groups`, that every table column is covered outside the table, and that code counts and failure boundaries remain bound to default values or input lengths.
