...
支持网页标签的 Markdown 轻量标记语言（Markdown）文档使用页面居中容器，并在容器标签与流程图之间保留空行；缺少空行可能让阅读器把流程图源代码当成普通文字
...
每个技术词汇在当前解释单位首次出现时完整说明；后续可以使用中文名称，但证据索引和需要精确核对的位置继续保留原始术语
...
- 逐项保留并解释清单中的正式术语；例如在“优先债权”后说明“处置抵押物时比本贷款更早拿到钱的债务”，在“资本支出”后说明“购买设备、厂房等长期资产的大额支出”
